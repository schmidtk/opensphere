...
class Controller extends AbstractAnnotationCtrl {
  ...
  constructor($scope, $element, $timeout) {
    ...
    ol.events.listen(this.feature, OLEventType.CHANGE, this.onFeatureChange_, this);
  ...
  disposeInternal() {
    ...
    ol.events.unlisten(this.feature, OLEventType.CHANGE, this.onFeatureChange_, this);
  ...
  onFeatureChange_() {
    ...
    if (this.feature && this.scope) {
      ...
      if (!this['options'].position) {
        ...
        var geometry = /** @type {SimpleGeometry} */ (this.feature.getGeometry());
        if (geometry) {
