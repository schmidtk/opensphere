...
const {EventType, DEFAULT_OPTIONS, EDIT_HEIGHT, EDIT_WIDTH} = goog.require('os.annotation');
...
class Controller extends Disposable {
  ...
  constructor($scope, $element, $timeout) {
    ...
    os.dispatcher.listen(EventType.LAUNCH_EDIT, this.cancelEdit, false, this);

    // initialize drag/resize after Angular has finished updating the DOM
  ...
  disposeInternal() {
    ...
    os.dispatcher.unlisten(EventType.LAUNCH_EDIT, this.cancelEdit, false, this);
